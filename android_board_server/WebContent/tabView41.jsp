...
//String sql = "SELECT SEQ, GENRE, REG_NM, APP_NM, APP_LINK, APP_PRICE, APP_DESC, DISCOUNT_YN, DISCOUNT_PER, DOWN_CNT, REG_DT, IMG_URL FROM TB_APP_INFO";                        // sql 쿼리

String sql = " SELECT TI.SEQ, TI.GENRE, TI.REG_NM, TI.APP_NM, TI.APP_LINK, TI.APP_PRICE, TI.APP_DESC, TI.DISCOUNT_YN, TI.DISCOUNT_PER, TI.DOWN_CNT, TI.REG_DT, TI.IMG_URL " 
		+ " FROM TB_USER_BOOKMARK TB LEFT OUTER JOIN TB_APP_INFO TI " 
		+ " ON TB.APP_SEQ = TI.SEQ "
		+ " WHERE TB.USER_ID = ? "
		+ " ORDER BY TI.SEQ ";
