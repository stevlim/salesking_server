...
try{
	...
	String searchCategoryCd = request.getParameter("searchCategoryCd");// new String(request.getParameter("searchTextVal").getBytes("8859_1"), "EUC-KR");
...
String sql = "SELECT SEQ, GENRE, REG_NM, APP_NM, APP_LINK, APP_PRICE, APP_DESC, DISCOUNT_YN, DISCOUNT_PER, DOWN_CNT, REG_DT, IMG_URL FROM TB_APP_INFO "
	+ " WHERE APP_EVENT_TYPE = '2' AND GENRE = ?";                        // sql 쿼리

pstmt = conn.prepareStatement(sql);                          // prepareStatement에서 해당 sql을 미리 컴파일한다.

pstmt.setString(1, searchCategoryCd);
